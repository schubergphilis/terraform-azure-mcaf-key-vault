...
| <a name="input_key_vault_secret_administrators"></a> [key\_vault\_secret\_administrators](#input\_key\_vault\_secret\_administrators) | Map of Key Vault Secret Administrators | <pre>map(object({<br/>    principal_id                     = string<br/>    skip_service_principal_aad_check = optional(bool, false)<br/>    principal_type                   = optional(string, null)<br/>  }))</pre> | `{}` | no |
