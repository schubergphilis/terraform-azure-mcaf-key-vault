...
|------|-------------|------|---------|:--------:|
| <a name="input_key_vault_administrators"></a> [key\_vault\_administrators](#input\_key\_vault\_administrators) | Set of Key vault Administrators | <pre>set(object({<br/>    principal_id                     = string<br/>    skip_service_principal_aad_check = optional(bool, false)<br/>    principal_type                   = optional(string, null)<br/>  }))</pre> | n/a | yes |
| <a name="input_key_vault_certificate_users"></a> [key\_vault\_certificate\_users](#input\_key\_vault\_certificate\_users) | Set of Key Vault Certificate Users | <pre>set(object({<br/>    principal_id                     = string<br/>    skip_service_principal_aad_check = optional(bool, false)<br/>    principal_type                   = optional(string, null)<br/>  }))</pre> | n/a | yes |
| <a name="input_key_vault_crypto_users"></a> [key\_vault\_crypto\_users](#input\_key\_vault\_crypto\_users) | Set of Key Vault Crypto Users | <pre>set(object({<br/>    principal_id                     = string<br/>    skip_service_principal_aad_check = optional(bool, false)<br/>    principal_type                   = optional(string, null)<br/>  }))</pre> | n/a | yes |
| <a name="input_key_vault_secret_users"></a> [key\_vault\_secret\_users](#input\_key\_vault\_secret\_users) | Set of Key Vault Secret Users | <pre>set(object({<br/>    principal_id                     = string<br/>    skip_service_principal_aad_check = optional(bool, false)<br/>    principal_type                   = optional(string, null)<br/>  }))</pre> | n/a | yes |
